...
namespace KnockemoutMVC.Models
{
    public class Impersonate
    {
        ...
        public string domainName { get; set; } = "DESKTOP-QFB330J";
        public string userName { get; set; } = @"paulalwin91@gmail.com";
        public string userPassword { get; set; } = "P4a3_U2l1";
        #endregion
